...
| F6 | Live-monitoring framework page | 2h | C5 | Egger/Vestal Hoeffding-style monitoring methodology (no citations) with threshold table and a worked example on the OOS sample | `[ ]` |
