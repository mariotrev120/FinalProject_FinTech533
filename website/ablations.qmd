...
Three calibrated XGBoost overlays were evaluated. One is activated in the headline; two are not.
...
| Skew-direction model | XGBoost picking which side of an iron condor will hurt more, used to dynamically tilt delta | Not applicable, the headline architecture is put-only | ✗ (not applicable) |
