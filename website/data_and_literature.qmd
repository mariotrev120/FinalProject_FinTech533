...
- **Bollerslev, Tauchen, Zhou (2009).** *Expected Stock Returns and Variance Risk Premia.* Review of Financial Studies. Establishes the 63-trading-day quarterly horizon as empirically optimal for VRP-based forecasting and motivates the Hodrick-style standard errors used for any overlapping regression in this work.
...
|---|---|
| OptionMetrics has 7-15% NaN on Greeks at deep-OTM/ITM strikes | [Limitations](limitations.qmd) |
| Per-instrument bars from a separate WRDS query (not from the chain file itself) | [Limitations](limitations.qmd) |
| TWS-sourced macro factors are point-in-time but not as-of-decision-time stamped | [Limitations](limitations.qmd) |
| Daily-frequency RV in the engine, not 5-minute intraday | [Limitations](limitations.qmd) |
| OOS sample only 7 years long | [Limitations](limitations.qmd) |
| RUT and NDX dropped because their underlying OHLC was not available locally | [Limitations](limitations.qmd) |
