...
> *How will you know your strategy is performing as expected?*
...
Backtested over the full 1,760 OOS trading days, the bound stayed at or above 50% on 88% of post-warmup trades and registered no critical signal across the 7-year window. The full framework, threshold table, worked example, and chart are on the [Live Monitoring](monitoring.qmd) page.
