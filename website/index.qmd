...
**Excess Sharpe +0.371** over OOS 2018-2024, beating the v1.5 single-name SPX put-only baseline (+0.286) by 0.085 with cross-asset diversification and 2× the trade sample.
...
- **Smooths the equity curve** during stress events. The defensive sleeve continued generating premium income through every named drawdown in the OOS sample, including weeks where a long equity book gave back 10% to 30%.
