...
| Sharpe (excess), without the ML overlay | +0.359 |
...
```{=html}
<iframe src="charts/equity_headline_vs_anchor.html" width="100%" height="560" frameborder="0"></iframe>
```
...
```{=html}
<iframe src="charts/drawdown_headline.html" width="100%" height="460" frameborder="0"></iframe>
```
...
```{=html}
<iframe src="charts/per_instrument_sharpe.html" width="100%" height="490" frameborder="0"></iframe>
```
...
```{=html}
<iframe src="charts/pnl_per_trade.html" width="100%" height="510" frameborder="0"></iframe>
```

## Trade-return distribution

```{=html}
<iframe src="charts/trade_return_distribution.html" width="100%" height="490" frameborder="0"></iframe>
```
...
*Showing 12 of 84 months from January 2018 to December 2024. Net P&L in dollars per spread (per-contract basis at $100 multiplier). Full ledger and blotter: [blotter.json](https://github.com/mariotrev120/FinalProject_FinTech533/blob/mario/data-pipeline/website/data/blotter.json) (437 trades, all fields).*
...
*Showing 10 of 437 trades. Full blotter: [blotter.json](https://github.com/mariotrev120/FinalProject_FinTech533/blob/mario/data-pipeline/website/data/blotter.json) (all 437 entries with every field).*
