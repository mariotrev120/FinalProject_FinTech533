...
|---|---:|---|:-:|
| Raw trials tested (N) | 12 |, |, |
| Avg pairwise return correlation (ρ̄) | 0.261 |, |, |
...
The halt framework's contribution is measurable per instrument and consistently positive.

## Per-event drawdown attribution

(Computed on the headline (D) basket equity curve)

| Event | Window | Book PnL impact | Halt fired? |
|---|---|---:|:-:|
| Volmageddon | 2018-02-05 ± 2w | _TBD_ | _TBD_ |
| Q4-2018 selloff | 2018-12-24 ± 1m | _TBD_ | _TBD_ |
| COVID crash | 2020-03-23 ± 1m | _TBD_ | _TBD_ |
| 2022 bear market | (full year) | _TBD_ | _TBD_ |
| Banking crisis | 2023-03-13 ± 1m | _TBD_ | _TBD_ |

(Filled in after stress-event-window analysis on the headline basket.)
