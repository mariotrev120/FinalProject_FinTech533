...
Computed on the headline basket equity curve, halts_only mode, equal-weight $50K per instrument (basket starting equity $200K). Drawdown is peak-to-trough WITHIN each window using a running cumulative max.
